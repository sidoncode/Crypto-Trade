...
public class BuyOrderAdapter extends RecyclerView.Adapter<BuyOrderAdapter.ViewHolder> {
    /**
    ...
    public BuyOrderAdapter(ArrayList<String> activityList, Activity activity) {
